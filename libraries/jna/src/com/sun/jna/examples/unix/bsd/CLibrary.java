...
public interface CLibrary extends Library {
	//public CLibrary INSTANCE = (CLibrary)Native.loadLibrary("/usr/lib/libc.dylib", CLibrary.class);
	 ...
	 * @return
	 */
	public int kevent(int kq, Pointer changelist, int nchanges, Pointer eventlist, int nevents, Pointer timeout);
