...
public class Preprocessor implements Closeable {
	...
	//ochafik:added{{
	private List<String>			frameworkspath;		/* -F @see http://developer.apple.com/DOCUMENTATION/DeveloperTools/gcc-3.3/gcc/Directory-Options.html */
	//}}ochafik
	...
	String findFile() {
		...
		while (source != null) {
			if (source instanceof FileLexerSource)
				return ((FileLexerSource)getSource()).getPath();
